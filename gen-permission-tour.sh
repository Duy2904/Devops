...
api_response=$(curl -s https://tour-api-dev.tripota.com.vn/api/resources -H 'tenant: root')
...
file="./src/utils/Permissions/TourPermissions.ts"  # Specify the path to your JavaScript/TypeScript file
...
echo "export enum TourPermissions {" >> "$file"
