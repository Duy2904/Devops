...
import { autoAddDefaultPermissions, sortPermissionsBy } from '@utils/defaultPermissions';
...
export const getRequest = (id: string, values: AnyObject) => {
    ...
    const request: CreateAgentPermissionsRequest = {
        groupId: id,
        permissions: [...listPermissions, ...autoAddDefaultPermissions],
    };
