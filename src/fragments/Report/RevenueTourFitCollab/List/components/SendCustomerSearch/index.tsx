...
import { useSendCustomerRevenueCollab } from '@fragments/Report/RevenueTourFitCollab/hook/useRevenueTourFit';

interface SendCustomerMultiSelectCollabProps {
    className?: string;
...
export const SendCustomerMultiSelectCollab: React.FC<SendCustomerMultiSelectCollabProps> = props => {
    const {
        tableParams,
    ...
    >([]);
    const { mutateAsync: fetchSendCustomer, isLoading } = useSendCustomerRevenueCollab();
