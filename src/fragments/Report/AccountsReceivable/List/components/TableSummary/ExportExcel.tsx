...
import { useExportExcel } from '@fragments/Report/AccountsReceivable/hook/useAccountsReceivable';
        ...
        if (signalConnectedId) {
            ...
            const params: ExportDebtReportRequest = {
                ...
                fileName: Format.formatExportExcelTitle(
                    `BCCongnoKhachhang${data.customerNo}_${dataName}_${currentDate}.xlsx`,
                ),
                locale: 'vi-VN',
            };
